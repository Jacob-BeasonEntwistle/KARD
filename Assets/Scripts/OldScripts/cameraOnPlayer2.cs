...
public class cameraOnPlayer2 : MonoBehaviour
{
    private Vector3 camPos;     // A variable to store the cameras position in the x, y and z axies.
    private Movement2 playerM2;   // A variable to store the player movement script.
    ...
    void Start()
    {
         ...
         * tag "Player2" and stores it in playerM variable. */
        playerM2 = GameObject.FindWithTag("Player2").GetComponent<Movement2>();
    }
    ...
    void LateUpdate()
    {
        ...
        camPos = playerM2.transform.position;
